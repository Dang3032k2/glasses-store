  ...
  return (
    <div className='mx-32 mb-32'>
      <div className='w-full h-[460px] bg-zinc-100 flex '>
        <div className='ml-14 mt-14 flex flex-1 items-center'>
          <h1 className='text-6xl font-medium'>Featured Products</h1>
        </div>
        <img src="/icons/banner-man.png" alt="" className='w-full flex-1 object-cover' />
      </div>
